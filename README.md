    ...
    sh -c "`curl -fsSL https://raw.githubusercontent.com/ryanmacg/dotfile-1/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/ryanmacg/dotfiles-1/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/ryanmacg/dotfiles-1/master/install.sh`" -s ask
```
